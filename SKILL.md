...
## 🔬 研究方向：[方向名]
### 📖 必读论文（按推荐阅读顺序）
| # | 论文 | 作者 | 期刊/会议 | 年 | 为什么读 | 📎 链接 |
|---|------|------|---------|-----|---------|------|
| 1 | 经典综述 | — | — | — | 建立全局认知 | arXiv/DOI |
| 2 | 开山之作 | — | — | — | 理解问题定义 | 会议官网 |
| 3-5 | 最新SOTA | — | — | 2024-2026 | 追踪前沿 | 论文URL + GitHub |
> 链接必填：优先 arXiv（免费），其次 DOI（doi.org），最后 Google Scholar

### 👤 核心研究者（中国高校，标注CCF-A和方向特色）
### 🏫 活跃团队（产出特点、适合什么学生）
### 💻 GitHub 代码（Stars、是否适合入门复现，**必须附链接**）
